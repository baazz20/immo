                    ...
                    <ul class="navbar-nav  justify-content-end">
                        <li class="nav-item d-flex align-items-center">
                            <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
                                ...
                                <span class="d-sm-inline d-none"> YAO</span>
                            </a>
                        </li>
                                ...
                                <div class="col-8">
                                    <div class="numbers">
                                        ...
                                        <h5 class="font-weight-bolder mb-0">
                                             4                                            <span class="text-success text-sm font-weight-bolder">candidat (s)</span>
                                        </h5>
                                    </div>
                                </div>
                                <div class="col-4 text-end">
                                ...
                                <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        <div>
                                                            <img src="assets/uploads/picture/Juniorassemian7@gmail.com_2021110462157.jpeg" class="avatar avatar-sm me-3">
                                                        </div>
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="mb-0 text-sm">ASSEMIAN                                                                Junior</h6>
                                                            <p class="text-xs text-secondary mb-0">
                                                                Juniorassemian7@gmail.com                                                            </p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    <span class="badge badge-sm bg-gradient-success">+22543963980</span>
                                                </td>
                                                ...
                                                <td class="align-middle">
                                                    ...
                                                    <a href="backend/suprimercandidat.php?idF=6" onclick="return confirm('Voulez vous vraiment le suprimer ?');" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        <div>
                                                            <img src="assets/uploads/picture/tanovelar6@gmail.com_20211105 at 031619.jpeg" class="avatar avatar-sm me-3">
                                                        </div>
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="mb-0 text-sm">TANO                                                                Velar Fran�ois</h6>
                                                            <p class="text-xs text-secondary mb-0">
                                                                Tanovelar6@gmail.com                                                            </p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    <span class="badge badge-sm bg-gradient-success">+2250101010101</span>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <span class="text-secondary text-xs font-weight-bold"></span>
                                                </td>
                                                <td class="align-middle">
                                                    ...
                                                    <a href="backend/suprimercandidat.php?idF=8" onclick="return confirm('Voulez vous vraiment le suprimer ?');" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                                        <i class="fas fa-trash"></i>
                                                    </a>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        <div>
                                                            <img src="assets/uploads/picture/bambadossi@gmail.com_20211105032151.jpeg" class="avatar avatar-sm me-3">
                                                        </div>
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="mb-0 text-sm">BAMBA
                                                                Klanan Doss�lb�tchin</h6>
                                                            <p class="text-xs text-secondary mb-0">
                                                                bambadossi@gmail.com                                                            </p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    <span class="badge badge-sm bg-gradient-success">+2550748382388</span>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <span class="text-secondary text-xs font-weight-bold"></span>
                                                </td>
                                                <td class="align-middle">
                                                    ...
                                                    <a href="backend/suprimercandidat.php?idF=9" onclick="return confirm('Voulez vous vraiment le suprimer ?');" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                                        <i class="fas fa-trash"></i>
                                                    </a>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        <div>
                                                            <img src="assets/uploads/picture/+2250779959455.jpeg" class="avatar avatar-sm me-3">
                                                        </div>
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="mb-0 text-sm">ASSOPKE                                                                Jean Morel</h6>
                                                            <p class="text-xs text-secondary mb-0">
                                                                                                                            </p>
                                                        </div>
                                                    </div>
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    <span class="badge badge-sm bg-gradient-success">+2250779959455</span>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <span class="text-secondary text-xs font-weight-bold"></span>
                                                </td>
                                                <td class="align-middle">
                                                    ...
                                                    <a href="backend/suprimercandidat.php?idF=10" onclick="return confirm('Voulez vous vraiment le suprimer ?');" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                                        <i class="fas fa-trash"></i>
                                                    </a>
                                                </td>
                                            </tr>
